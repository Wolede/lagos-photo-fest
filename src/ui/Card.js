                ...
                <div className="card__main">
                    ...
                    <div className="card__info">
                        ...
                        <div className="card__details--info">
                            ...
                            <h2 className="semi-bold card__details--info__h">Nigerian</h2>
                        </div>
                        <div className="card__details--info">
                            <p className="regular card__details--info__p">Date of Birth</p>
                            <h2 className="semi-bold card__details--info__h">Jan 18 1985</h2>
                        </div>
                        <div className="card__details--info split">
                            <div>
                                <p className="regular card__details--info__p">Sex</p>
                                <h2 className="semi-bold card__details--info__h">M</h2>
                            </div>
                            <div>
                                <p className="regular card__details--info__p">Place of Birth</p>
                                <h2 className="semi-bold card__details--info__h">Lagos</h2>
                            </div>
                        </div>
                        <div className="card__details--info">

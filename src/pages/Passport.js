...
class Passport extends Component {
  ...
  handleConfirm = () => {
    ...
    setTimeout(() => {
      //this should change to the ajax method
      // if successful
  ...
  render() {
    ...
    return (
      <div className="passport__card__container">
        ...
        <div>
          {this.state.confirmed === false && (
            ...
            <button
              ...
              className={`button secondary passport__btn ${this.state.buttonError}`}
            >
          ...
          {this.state.confirmed === true && (
            ...
            <button
              ...
              className={`button primary passport__btn ${this.state.buttonError}`}
            >
              Download
            </button>
          )}
        ...
        <a href="#" className="passport__link">
          {" "}
          Go back
        </a>
      </div>
